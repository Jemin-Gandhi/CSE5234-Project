              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-3">
                  ...
                  {errors.credit_card_number && (
                    <div className="invalid-feedback">{errors.credit_card_number}</div>
                  )}
                </div>
                ...
                <div className="row">
                  <div className="col-md-6 mb-3">
                    ...
                    />
                    {errors.expir_date && (
                      <div className="invalid-feedback">{errors.expir_date}</div>
                    )}
                  </div>
                  ...
                  <div className="col-md-6 mb-3">
                    ...
                    />
                    {errors.cvvCode && (
                      <div className="invalid-feedback">{errors.cvvCode}</div>
                    )}
                  </div>
                </div>
